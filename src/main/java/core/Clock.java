...
// core.Clock implements an Observable which returns the current time every x seconds, where x is 2 in
// our case.
public class Clock extends java.util.Observable {
  ...
  // Function that notifies the core.Clock's observers with the current time.
